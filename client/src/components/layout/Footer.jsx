...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-linear-to-b from-slate-900 via-slate-900 to-slate-950 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 bg-gray-50 text-gray-900 overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,var(--tw-gradient-stops))] from-slate-800/20 via-transparent to-transparent" />
            ...
            <div className="flex items-center space-x-2">
              {socialLinks.map((social, index) => {
                ...
                return (
                  ...
                  >
                    <Icon
                      className={`w-5 h-5 text-slate-400 ${social.color} transition-colors`}
                    />
                  </motion.a>
                );
              })}
