...
const Sidebar = () => {
  ...
  return (
    <motion.aside
      ...
      className={`
        relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-r border-gray-200/50 dark:border-gray-700/50
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="absolute -right-3 top-8 z-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full p-1.5 shadow-md hover:shadow-lg transition-shadow"
      ...
      <div className="p-4 h-full flex flex-col overflow-y-auto scrollbar-hide">
        ...
        {!collapsed && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="mb-6 p-4 bg-gradient-to-br from-primary-50 to-secondary-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl border border-primary-100/50 dark:border-gray-700"
          >
            ...
            {isAdmin() && (
              <Badge variant="outline" className="mt-3 w-full justify-center bg-white/50 dark:bg-gray-700/50 border-primary-200 dark:border-gray-600">
              ...
              >
                ...
                {collapsed && isHovered && (
                  <motion.div
                    ...
                    className="absolute left-full ml-2 px-3 py-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg whitespace-nowrap z-50"
                  >
