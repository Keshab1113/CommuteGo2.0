...
class Route {
  static async create({ userId, source, destination, travelDate }) {
    const [result] = await db.execute(
      'INSERT INTO routes (user_id, source, destination, travel_date) VALUES (?, ?, ?, ?)',
      [userId, source, destination, travelDate]
    );
